...
<div class="step-card">
    ...
    <p>Temukan aplikasi: <code>Buka aplikasi Telegram Anda dan cari @duitect_bot di kolom pencarian.</code></p>
</div>
<div class="step-card">
...
st.markdown(
    ...
    <div style="text-align: center; padding: 20px; font-size: 0.9em; color: #555;">
        <p>&copy; 2025 Chatbot Pengelola Keuangan Pribadi. All rights reserved.</p>
